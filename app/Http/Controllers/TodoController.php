...
class TodoController extends Controller
{
    ...
    public function complete(Todo $todo)
    {
        if (auth()->user()->id == $todo->user_id) {
            ...
            return redirect()->route('todo.index')->with('danger', 'Your are not authorized to complete this todo!');
        }
    }
    ...
    public function uncomplete(Todo $todo)
    {
        if (auth()->user()->id == $todo->user_id) {
            ...
            return redirect()->route('todo.index')->with('danger', 'Your are not authorized to uncomplete this todo!');
        }
    }
